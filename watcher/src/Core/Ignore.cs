...
public static class Ignore
{
    ...
    public static readonly string[] FileNames = new[] { ".DS_Store", "Thumbs.db" };

    public static readonly string[] FileExtensions = new[] { ".swp", ".tmp" };
    ...
    public static bool IsIgnored(string path)
    {
        ...
        {
            if (string.Equals(name, f, StringComparison.Ordinal))
                return true;
        }
